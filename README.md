...
Usage Each section has useful notes for HTML, CSS, JavaScript, and Git. You can see JavaScript running when you open the devtools, which can be accessed through right click+inspect or F12.
